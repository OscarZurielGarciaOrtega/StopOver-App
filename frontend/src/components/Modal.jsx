...
export default function Modal({ isOpen, onClose, onConfirm, title, message }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-6 transform transition-all animate-in fade-in zoom-in-95">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="flex-1 bg-red-600 hover:bg-red-700 text-white font-semibold py-2.5 rounded-xl transition-colors shadow-sm"
          >
            Sí, eliminar
          </button>
        </div>
