...
export default function Recovery() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (validateForm()) {
      console.log('Solicitud válida. Listo para disparar el correo vía Postfix con Spring Boot');
    }
  };
    ...
    <div className="min-h-screen bg-[#F5F5F5] flex items-center justify-center p-4 font-sans">
      ...
      <div className="bg-white rounded-[32px] shadow-lg flex flex-col md:flex-row w-full max-w-5xl overflow-hidden border border-gray-100">
        ...
        <div className="w-full md:w-7/12 p-8 md:p-16 flex flex-col justify-center bg-[#FAFAF8]">
          ...
          <p className="text-gray-500 font-medium mb-10 text-center">No te preocupes, te ayudamos a recuperarla</p>
